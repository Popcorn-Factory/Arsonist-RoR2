...
Shader "Shader Forge/masochismWaveShader2" {
    Properties {
        ...
        _FrenelMultiplier ("Frenel Multiplier", Range(0, 100)) = 1
...
////// Emissive:
                ...
                float3 emissive = (floor(((node_9992*_TextureColor_var.rgb)*(step((node_17.rgb*(1.0 - _OneMinusTexture_var.rgb)),_StepThreshold_var)+_TextureColor_var.rgb)) * _PosterizeSteps_var) / (_PosterizeSteps_var - 1)*_glow_var);
                ...
                return fixed4(finalColor,((1.0 - i.uv0.b)*floor((saturate((node_1884*_OneMinusTexture_var.r))*node_1884) * node_6523) / (node_6523 - 1)));
            }
            ENDCG
        }
        Pass {
