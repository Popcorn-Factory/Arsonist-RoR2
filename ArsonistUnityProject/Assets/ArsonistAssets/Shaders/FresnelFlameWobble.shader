...
Shader "Unlit/FresnelFlameWobble"
{
    Properties
    {
        ...
        _OutlineExtend("Outline Extend", Range(0,1)) = 0.02
    }
    SubShader
    {
...
//          #pragma exclude_renderers d3d11
            ...
            v2f vert(appdata v)
            {
                ...
                transformedVertex = float4(transformedVertex.xyz + v.normal * _OutlineExtend, 1);
