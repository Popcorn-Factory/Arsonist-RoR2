...
Shader "Shader Forge/masochismWaveShader" {
    Properties {
        ...
        _Durationthreshold ("Duration threshold", Float ) = 0.1
    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _Durationthreshold)
...
////// Emissive:
                ...
                float node_6890 = fmod(node_7558.g,_Duration_var);
                float _Durationthreshold_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Durationthreshold );
                float node_3828_if_leA = step(node_6890,_Durationthreshold_var);
                float node_3828_if_leB = step(_Durationthreshold_var,node_6890);
                float node_1446 = smoothstep( 0.0, _Duration_var, node_6890 );
                ...
                return fixed4(finalColor,(lerp((node_3828_if_leA*node_1446)+(node_3828_if_leB*(1.0 - node_1446)),node_1446,node_3828_if_leA*node_3828_if_leB)*node_1884));
            }
            ENDCG
        }
        Pass {
