...
////// Emissive:
                ...
                float3 emissive = (_glow_var*floor(((node_9992*_TextureColor_var.rgb)*(step((node_17.rgb*(1.0 - _OneMinusTexture_var.rgb)),_StepThreshold_var)+_TextureColor_var.rgb)) * _PosterizeSteps_var) / (_PosterizeSteps_var - 1));
