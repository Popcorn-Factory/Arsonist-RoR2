...
/*SF_DATA;ver:1.40;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,cpap:True,lico:1,lgpr:1,limd:2,spmd:0,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:2,hqsc:True,nrmq:0,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:2,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:3138,x:32888,y:32567,varname:node_3138,prsc:2|diff-5858-OUT,diffpow-4069-OUT,emission-5858-OUT,alpha-4712-OUT,voffset-9388-OUT;n:type:ShaderForge.SFN_Color,id:7241,x:31941,y:32619,ptovrint:False,ptlb:TextureColor,ptin:_TextureColor,varname:node_7241,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0.5681818,c3:0,c4:0.1;n:type:ShaderForge.SFN_Tex2dAsset,id:8115,x:31782,y:32533,ptovrint:False,ptlb:TextureInput,ptin:_TextureInput,varname:node_8115,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:9337cc1a2c6d9244bb19033e87030afc,ntxv:2,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:17,x:32147,y:32459,varname:node_17,prsc:2,tex:9337cc1a2c6d9244bb19033e87030afc,ntxv:0,isnm:False|UVIN-8834-UVOUT,TEX-8115-TEX;n:type:ShaderForge.SFN_Slider,id:6350,x:31795,y:32829,ptovrint:False,ptlb:Opacity,ptin:_Opacity,varname:_exponent_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Add,id:5858,x:32412,y:32672,varname:node_5858,prsc:2|A-17-RGB,B-7241-RGB;n:type:ShaderForge.SFN_TexCoord,id:174,x:31563,y:32302,varname:node_174,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Panner,id:8834,x:31968,y:32374,varname:node_8834,prsc:2,spu:1,spv:1|UVIN-174-UVOUT,DIST-2794-OUT;n:type:ShaderForge.SFN_Time,id:7558,x:31250,y:32087,varname:node_7558,prsc:2;n:type:ShaderForge.SFN_RemapRange,id:2794,x:31755,y:32181,varname:node_2794,prsc:2,frmn:0,frmx:1,tomn:-1,tomx:1|IN-3119-OUT;n:type:ShaderForge.SFN_NormalVector,id:3190,x:31929,y:33038,prsc:2,pt:False;n:type:ShaderForge.SFN_Multiply,id:9603,x:32235,y:32931,varname:node_9603,prsc:2|A-17-RGB,B-3190-OUT;n:type:ShaderForge.SFN_Multiply,id:9388,x:32531,y:33018,varname:node_9388,prsc:2|A-6083-OUT,B-9603-OUT;n:type:ShaderForge.SFN_Slider,id:6083,x:32157,y:33091,ptovrint:False,ptlb:Vertex offset,ptin:_Vertexoffset,varname:node_6083,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.1574405,max:1;n:type:ShaderForge.SFN_Multiply,id:3845,x:31618,y:32006,varname:node_3845,prsc:2|A-7009-OUT,B-7558-T;n:type:ShaderForge.SFN_Slider,id:7009,x:31250,y:32007,ptovrint:False,ptlb:Time Multiplier,ptin:_TimeMultiplier,varname:node_7009,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:300;n:type:ShaderForge.SFN_Sin,id:3119,x:31801,y:31989,varname:node_3119,prsc:2|IN-3845-OUT;n:type:ShaderForge.SFN_VertexColor,id:1582,x:32391,y:32245,varname:node_1582,prsc:2;n:type:ShaderForge.SFN_Multiply,id:2188,x:32579,y:32319,varname:node_2188,prsc:2|A-1582-RGB,B-4069-OUT;n:type:ShaderForge.SFN_Slider,id:4069,x:32174,y:32382,ptovrint:False,ptlb:Lighting Multiplier,ptin:_LightingMultiplier,varname:node_4069,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Multiply,id:4712,x:32391,y:32822,varname:node_4712,prsc:2|A-17-A,B-6350-OUT;proporder:7241-8115-6350-6083-7009-4069;pass:END;sub:END;*/
