...
Shader "Shader Forge/masochismWaveShader" {
    Properties {
        ...
        _LowerLerpOpacity ("LowerLerpOpacity", Range(0, 1)) = 0.2641549
        _UpperLerpOpacity ("UpperLerpOpacity", Range(0, 1)) = 0.8656861
