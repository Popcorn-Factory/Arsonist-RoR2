...
{
    public class ZeroPointBlastStateless : BaseSkillState

    {
        ...
        public override void FixedUpdate()
        {
            ...
            if (this.stopwatch >= duration * 0.95f) 
            {
        ...
        protected virtual void OnHitEnemyAuthority()
        {
            ...
            {
                hasHit = true;
                this.PlayCrossfade("FullBody, Override", "ZPBHit", 0.05f);
            }
